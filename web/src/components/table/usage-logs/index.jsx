...
import LogContentDrawer from './modals/LogContentDrawer';
...
const LogsPage = () => {
  ...
  return (
    <>
      ...
      <LogContentDrawer
        visible={logsData.showLogContentDrawer}
        onClose={() => logsData.setShowLogContentDrawer(false)}
        requestId={logsData.logContentRequestId}
      />
